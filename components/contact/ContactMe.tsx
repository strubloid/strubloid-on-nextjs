                        ...
                        <Row>
                            <Col className="ml-auto mr-auto" md="5">
                                ...
                                <p className="description">
                                    If you want to have a chat about <b>Coffee</b>, <b>PHP</b>, <b>React</b>, <b>Bash(Shellscript)</b> or any <b>new Tecnology</b>, please send me a
                                    message, I will promisse that I will get back to you!
                                    <br />
                                    <br />
                                ...
                                {isSubmitting ? (
                                    ...
                                    <Form id="contact-me" onSubmit={handleOnSubmit}>
                                        ...
                                        <div className="submit text-center">
                                            <Button className="btn-raised btn-round btn btn-info" type="submit" disabled={status.submitting}>
