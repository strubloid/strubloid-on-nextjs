...
export const rafaelTimeline: TimelineItem[] = [
  ...
  },
  {
    id: "2020-blocworx",
    year: "2020-2024",
    title: "Senior Architect No-Code Solution",
    company: "Blocworx",
  ...
  },
  {
    id: "2019-monsoon",
    year: "2019-2020",
    title: "Full-stack Developer, Magento II",
    ...
    highlights: [
      ...
      "Collaborated across QA, DevOps, and design teams on deployment pipelines",
    ],
    color: "#A8DADC",
  },
  {
    id: "2016-studiofourty9",
    year: "2016-2018",
    title: "Full-stack Developer, Magento I",
    ...
    highlights: [
      ...
      "Mentored junior developers on Magento standards and best practices",
    ],
    color: "#E8B631",
  },
  {
    id: "2012-captura",
    year: "2012-2016",
    title: "Full Stack Zend and React",
    company: "Captura.Me",
    ...
    highlights: [
      ...
      "Fixed critical Zend Framework II bug (PR #3017, merged Jan 4, 2013)",
    ],
    color: "#F2A07A",
  },
  {
    ...
    highlights: [
      ...
      "Led REGEX-driven refactor of 200+ templates for consistency",
      "Mentored frontend team through pair programming on jQuery",
    ],
    color: "#A8DADC",
  },
  {
    ...
    highlights: [
      ...
      "Presented innovation at major IT event, raising company tech profile",
    ],
    color: "#457B9D",
  },
  {
  ...
  },
  {
    ...
    position: "João Pessoa, Brazil",
    description:
      "Focused on hands-on programming in Python with emphasis on game development. Built 20+ 2D games using Python and Pygame as part of Firestorm team.",
    skills: ["Python", "Pygame", "Game Development", "OOP", "Git"],
    highlights: [
      "Developed 20+ 2D games with event handling and collision detection",
      "Contributed to Free Software groups (GLUGPB & CETI)",
      "Promoted open-source culture through tech talks and collaborative events",
    ],
    color: "#A8DADC",
  },
];
